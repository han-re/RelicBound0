function addToInventory(itemSrc){
    ...
    item.src = itemSrc;                                                 //This function adds the inventory image to the bar.
 ...
 //This is to obtain the userInvId and store it in the userInvId variable below.
         ...
         insertIntoInventory(userId,2); //Make sure the itemId is the correct one corresponding to the ItemId table in the database
